class Graph3DComponent extends Component 
{
    constructor(options) 
    {
        ...
        /* cube(); sphere(); parabolicCylinder(); oneSheetHyperboloid(); hyperbolicParaboloid(); hyperbolicCylinder(); 
        ellipticalParaboloid(); ellipticalCylinder(); ellipsoid(); cone(); twoSheetHyperboloid();*/ 
