class Math3D 
{
    ...
    pointsToVectors(point1, point2, point3) 
    { // Из данных трех точек составляем 2 вектора 
